...
<head>
  ...
  <!-- Font Awesome Icons -->
  <link rel="stylesheet" href="<?= base_url() ?>/Assets/js/plugins/fontawesome-free/css/all.min.css">
  <!-- Ionicons -->
  <link rel="stylesheet" href="https://code.ionicframework.com/ionicons/2.0.1/css/ionicons.min.css">
  <!-- overlayScrollbars -->
  <link rel="stylesheet" href="<?= base_url() ?>/Assets/js/plugins/overlayScrollbars/css/OverlayScrollbars.min.css">
  <!-- Theme style -->
  ...
  <link rel="stylesheet" href="<?= base_url() ?>/Assets/js/plugins/datatables-responsive/css/responsive.bootstrap4.min.css">
  <link rel="stylesheet" href="<?= base_url() ?>/Assets/js/plugins/datatables-buttons/css/buttons.bootstrap4.min.css">
</head>
  ...
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="" class="brand-link">
        ...
        <span class="brand-text font-weight-light">SCSAAIJ V3</span>
      </a>
